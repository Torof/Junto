-- Migration 00078: ensure create_activity includes objective params
-- Migrations 00069-00076 may have been rolled back when 00076 failed,
-- then marked as applied via repair. Re-apply the function definition.
