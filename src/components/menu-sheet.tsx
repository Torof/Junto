    ...
    <>
      ...
      >
        <BottomSheetView style={styles.content}>
          ...
          <MenuItem
            icon={<CalendarDays size={20} color={colors.textPrimary} strokeWidth={2.2} />}
            label={t('menu.mesActivites', { defaultValue: 'Mes sorties' })}
            onPress={() => go('/(auth)/(tabs)/mes-activites')}
            styles={styles}
            colors={colors}
          />
          <MenuItem
