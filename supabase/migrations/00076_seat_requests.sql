...
BEGIN
  ...
  SELECT transport_from_name INTO v_from_name FROM participations WHERE activity_id = v_req.activity_id AND user_id = v_req.requester_id AND status = 'accepted';
