...
// (pin system v4 / taxonomy v2, migration 00281). Used both as the activity
// accent (cards/popups/detail/offerings) and as the pro pushpin disc color.
// Retired-sport categories fall back to the CTA color.
//   mountain green · water blue · air violet · cycling slate · running crimson
