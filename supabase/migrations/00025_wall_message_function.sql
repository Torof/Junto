-- Migration 00025: send_wall_message function
-- Authorization chain: auth + suspension + activity active + accepted participant + rate limit
...
BEGIN
  ...
  VALUES (p_activity_id, v_user_id, trim(p_content), now())
